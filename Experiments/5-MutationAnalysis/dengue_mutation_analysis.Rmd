...
grid.arrange(arg_vs_rscu_fc, heights = c(10), widths = 10)
```
...
# plot arginine as an example 
arg_w_status_fill = plot_status_per_aa_bar(synonymous_mutation_data_fitness_class_perc, 'Arg')
...
# save 
pdf('./data/mrf_corr_human_mosquito.pdf')
